...
const zh: Texts = {
  ...
  ocr_b_ls_intro: "生命科学楼承担生物与相关学科的教学与实验，是北校区重要的科研与实验教学场所。",
  ...
  ocr_b_sb_intro: "理科楼 B 是 S 楼群的重要组成，承担理科类课程与实验教学。",
  ocr_b_sc_name: "理科楼 C (SC)",
  ocr_b_sc_intro: "理科楼 C 是 S 楼群的重要组成，承担理科类课程与实验教学。",
  ocr_b_sd_name: "理科楼 D (SD)",
  ocr_b_sd_intro: "理科楼 D 是 S 楼群的重要组成，承担理科类课程与实验教学。",
  ...
  ocr_b_pb_intro: "公共楼承担承担理科类课程与药学院相关实验教学。",
...
const en: Texts = {
  ...
  ocr_b_ls_intro: "Life Sciences supports biology-related teaching and labs, a key research and learning hub on nouth campus.",
  ...
  ocr_b_sb_intro: "SB is part of the S-block cluster, hosting science courses and teaching labs.",
  ocr_b_sc_name: "Science Building C (SC)",
  ocr_b_sc_intro: "SC is part of the S-block cluster, hosting science courses and teaching labs.",
  ocr_b_sd_name: "Science Building D (SD)",
  ocr_b_sd_intro: "SD is part of the S-block cluster, hosting science courses and teaching labs.",
  ...
  ocr_b_pb_intro: "The Public Building supports some mathematic classes and courses related to the School of Pharmacy",
